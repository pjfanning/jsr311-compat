...
/**
 * An I/O exception thrown by javax.ws.rs.ext.MessageBodyReader implementations
 ...
 * translated by JAX-RS server runtime into a javax.ws.rs.BadRequestException
 * wrapping the original {@code NoContentException} and rethrown for a standard processing by
 * the registered javax.ws.rs.ext.ExceptionMapper exception mappers.
 * </p>
 *
